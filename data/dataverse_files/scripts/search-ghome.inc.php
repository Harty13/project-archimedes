...
<form method="GET" action="https://search.socialhistory.org/Search/Results" name="searchForm">
  ...
  <input type="text" name="lookfor" size="11">
  <input type="submit" name="submit" value="Go" style="background-color:#C42737; color:#fff;">
</form>
	</dd>
...
<form id="cse-search-box" action="https://www.iisg.nl/g-search.php">
  ...
  <input type="submit" name="sa" value="Go" style="background-color:#C42737; color:#fff;">
</form>
<br>
</dl>
