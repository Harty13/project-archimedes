...
<html>
<head>
<title>Scottish Economic History Database, 1550 - 1780</title>
...
<script language="javascript" type="text/javascript">
  ...
  var host2 = "g.nl"
  var host1 = "iis"
  document.write("<a href=" + "mail" + "to:" + wie + "@" + host1 + host2 + ">J.L. van Zanden<\/a>")
  //-->
</script></dd>
		</dl>
	...
	<h2>Scottish Economic History Database, 1550 - 1780</h2>
	<h4>Map of Scotland</h4>

<img src="scotmap.jpg" alt="Map of Scotland" width="515" height="510" border="0" title="Map of Scotland">
<p>
Browse database by <a href="scotlist.php">Counties and Places</a></p>
