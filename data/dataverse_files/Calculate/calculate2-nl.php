...
<html>
<head>
	<title>Waarde van de gulden / euro</title>
...
<h2>Waarde van de gulden / euro</h2>
<p>
<?php 
	...
	if( $valuta == 'gulden' ) {
		echo "<strong>fl " . number_format($money, 2, ".", " ") . "</strong> in het jaar <strong>$year2</strong> <BR><BR>heeft een \"koopkracht\" van <BR><BR><strong>fl. " . number_format($money2,2, ".", " ") . "</strong> (&euro; " . number_format($money2/2.20371,2, ".", " ") . ") in het jaar <strong>$year1</strong>";
	} else if( $valuta == 'euro' ) {
		echo "<strong>&euro; " . number_format($money, 2, ".", " ") . "</strong> van het jaar <strong>$year2</strong> <BR><BR>heeft een \"koopkracht\" van <BR><BR><strong>&euro; " . number_format($money2,2, ".", " ") . "</strong> (fl. " . number_format($money2*2.20371,2, ".", " ") . ") in het jaar <strong>$year1</strong>";
	}
?>
</p>
<h3><a href="/hpw/calculate-nl.php">Opnieuw berekenen?</a></h3>
